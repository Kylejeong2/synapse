			...
			<div className="w-full">
				...
				<div className="flex flex-col sm:flex-row items-center justify-center gap-4 mt-16">
					{[
						...
						<div
							key={s.n}
							className="w-full sm:w-auto flex items-center gap-3 rounded-md border border-[#e8e3d9] bg-[#faf8f3] px-6 py-4"
						>
							<span className="h-7 w-7 rounded-full bg-[#1a1715] text-[#faf8f3] text-sm font-bold flex items-center justify-center shrink-0">
								{s.n}
							</span>
							<span className="text-lg text-[#1a1715]">{s.label}</span>
						</div>
					))}
				</div>
			</div>
