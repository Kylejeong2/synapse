		...
		<section className="bg-[#1a1715] text-[#faf8f3] py-24 sm:py-32 landing-section">
			<div className="w-full">
				<div className="text-center mb-20">
					...
					<p className="text-xl text-[#b5aea6]">
	...
	return (
		<div className="flex flex-col lg:flex-row items-start gap-12 lg:gap-20 mb-28">
			<div className="flex-1 max-w-lg pt-2">
				<p className="text-base font-semibold tracking-wide text-[#c4642a] mb-4">
					Multi-model
				</p>
				<h3 className="text-3xl sm:text-4xl font-semibold tracking-tight mb-4">
					Same prompt, different minds
				</h3>
				<p className="text-[#b5aea6] leading-relaxed text-lg">
			...
			<div className="flex-1 w-full">
				<div className="space-y-3">
					<div className="flex justify-end mb-3">
						<div className="rounded-xl px-5 py-3 bg-[#faf8f3] text-[#1a1715] text-base max-w-[75%]">
					...
					{[
						...
						<div
							key={m.name}
							className="rounded-lg border border-[#333] bg-[#262220] p-5"
						>
							<span className="text-base font-semibold text-[#c4642a]">
								{m.name}
							</span>
							<p className="text-base text-[#b5aea6] mt-1.5 leading-relaxed">
								{m.text}
							</p>
						</div>
					))}
...
function NavigationFeature() {
	return (
		<div className="flex flex-col lg:flex-row-reverse items-start gap-12 lg:gap-20 mb-28">
			...
			<div className="flex-1 w-full">
				<div className="rounded-lg border border-[#333] bg-[#262220] overflow-hidden">
					<div className="px-4 py-3 border-b border-[#333] flex items-center gap-2">
						<Network className="h-4.5 w-4.5 text-[#6b6560]" />
				...
				<div className="rounded-lg border border-[#333] bg-[#262220] p-6">
					<div className="space-y-3">
						{[
							...
							<div
								key={item.label}
								className={`flex items-center justify-between rounded border-l-2 ${item.depth === 0 || item.depth === 3 ? "border-l-[#c4642a]" : "border-l-[#6b6560]"} bg-[#1a1715] px-4 py-3`}
								style={{ marginLeft: `${item.depth * 16}px` }}
							>
								<span className="text-base font-medium text-[#faf8f3] truncate mr-4">
									{item.label}
								</span>
					...
					<p className="text-sm text-[#6b6560] text-center mt-5">
